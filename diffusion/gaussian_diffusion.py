...
class GaussianDiffusion:
    ...
    def p_mean_variance(
        ...
        if model_kwargs is not None:
            model_output = model(x, self._scale_timesteps(t), sparse, style_code.repeat(sparse.shape[0],1,1), **model_kwargs)
        else:
            model_output = model(x, self._scale_timesteps(t), sparse, style_code.repeat(sparse.shape[0],1,1))
