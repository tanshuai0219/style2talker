...
def add_base_options(parser):
    ...
    group.add_argument("--config", default=None, type=str, help="Device id to use.")
    group.add_argument("--seed", default=10, type=int, help="For fixing random seed.")
    group.add_argument(
        "--batch_size", default=256, type=int, help="Batch size during training."
    )
    group.add_argument(
...
def add_model_options(parser):
    ...
    group.add_argument(
        "--audioencoder_ckpt", type=str, default=None)
